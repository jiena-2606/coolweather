...
public class WeatherActivity extends Activity implements OnClickListener{
				...
				if("countyCode".equals(type)){
					if(!TextUtils.isEmpty(response)){
						...
						if(array != null && array.length == 2){
							String wreatherCode = array[1];
							queryWreatherInfo(wreatherCode);
						}
					}
	...
	private void queryWreatherInfo(String wreatherCode){
		String address = "http://www.weather.com.cn/data/cityinfo/" + wreatherCode +".html";
		/*SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(this).edit();
		editor.putString("weather_code", wreatherCode);
		editor.commit();*/
